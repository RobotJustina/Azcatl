...
*
*	PROYECTO <ÁZCATL>
*		Nodo principal para el manejo del robot Ázcatl
			El principal objetivo de este nodo es el seguimiento de una fuente luminosa utilizando comportamiento reactivo.
*
...
int main(int  argc, char** argv){
	...
	std::cout<<"_>>Azcatl en linea para seguimiento de una fuente luminosa..."<<std::endl;
