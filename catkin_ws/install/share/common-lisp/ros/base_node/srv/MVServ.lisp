...
(cl:defmethod cl:initialize-instance :after ((m <MVServ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MVServ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base_node-srv:<MVServ-request> is deprecated: use base_node-srv:MVServ-request instead.")))

(cl:ensure-generic-function 'param-val :lambda-list '(m))
(cl:defmethod param-val ((m <MVServ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:param-val is deprecated.  Use base_node-srv:param instead.")
  (param m))

(cl:ensure-generic-function 'coord_x-val :lambda-list '(m))
(cl:defmethod coord_x-val ((m <MVServ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:coord_x-val is deprecated.  Use base_node-srv:coord_x instead.")
  (coord_x m))

(cl:ensure-generic-function 'coord_y-val :lambda-list '(m))
(cl:defmethod coord_y-val ((m <MVServ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:coord_y-val is deprecated.  Use base_node-srv:coord_y instead.")
  (coord_y m))

(cl:ensure-generic-function 'coord_ang-val :lambda-list '(m))
(cl:defmethod coord_ang-val ((m <MVServ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:coord_ang-val is deprecated.  Use base_node-srv:coord_ang instead.")
  (coord_ang m))
...
(cl:defmethod cl:initialize-instance :after ((m <MVServ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MVServ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base_node-srv:<MVServ-response> is deprecated: use base_node-srv:MVServ-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <MVServ-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:answer-val is deprecated.  Use base_node-srv:answer instead.")
  (answer m))
