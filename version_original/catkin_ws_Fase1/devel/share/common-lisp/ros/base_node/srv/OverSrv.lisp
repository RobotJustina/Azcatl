...
(cl:defmethod cl:initialize-instance :after ((m <OverSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OverSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base_node-srv:<OverSrv-request> is deprecated: use base_node-srv:OverSrv-request instead.")))

(cl:ensure-generic-function 'over_flg-val :lambda-list '(m))
(cl:defmethod over_flg-val ((m <OverSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_node-srv:over_flg-val is deprecated.  Use base_node-srv:over_flg instead.")
  (over_flg m))
...
(cl:defmethod cl:initialize-instance :after ((m <OverSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OverSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base_node-srv:<OverSrv-response> is deprecated: use base_node-srv:OverSrv-response instead.")))
